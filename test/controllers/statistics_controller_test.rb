...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { game: @statistic.game, total: @statistic.total, type: @statistic.type, user: @statistic.user } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { game: @statistic.game, total: @statistic.total, type: @statistic.type, user: @statistic.user } }
